...
test_cpp:     file format elf64-x86-64
...
0000000000001090 <deregister_tm_clones>:
    ...
    1097:	48 8d 05 72 2f 00 00 	lea    0x2f72(%rip),%rax        # 4010 <completed.0>
...
00000000000010c0 <register_tm_clones>:
    10c0:	48 8d 3d 49 2f 00 00 	lea    0x2f49(%rip),%rdi        # 4010 <completed.0>
    10c7:	48 8d 35 42 2f 00 00 	lea    0x2f42(%rip),%rsi        # 4010 <completed.0>
...
0000000000001100 <__do_global_dtors_aux>:
    ...
    1104:	80 3d 05 2f 00 00 00 	cmpb   $0x0,0x2f05(%rip)        # 4010 <completed.0>
    ...
    112c:	c6 05 dd 2e 00 00 01 	movb   $0x1,0x2edd(%rip)        # 4010 <completed.0>
    1133:	5d                   	pop    %rbp
    1134:	c3                   	ret    
...
0000000000001149 <main>:
    ...
    1155:	bf 28 00 00 00       	mov    $0x28,%edi
    115a:	e8 f1 fe ff ff       	call   1050 <_Znam@plt>
    115f:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
...
0000000000001170 <__libc_csu_init>:
    ...
    1174:	41 57                	push   %r15
    1176:	4c 8d 3d 2b 2c 00 00 	lea    0x2c2b(%rip),%r15        # 3da8 <__frame_dummy_init_array_entry>
    117d:	41 56                	push   %r14
    ...
    118c:	55                   	push   %rbp
    118d:	48 8d 2d 1c 2c 00 00 	lea    0x2c1c(%rip),%rbp        # 3db0 <__do_global_dtors_aux_fini_array_entry>
    1194:	53                   	push   %rbx
